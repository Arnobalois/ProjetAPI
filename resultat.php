  ...
  <body style="background: rgb(150,180,255)">
    <div class="container-xxl">
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="row">
            <div class="col-md-5" style="border: 5px solid rgb(111,41,97)">
              <span class="badge badge-default">Notes : </span>
              <ul>
                <?php
                foreach ($json->Ratings as $note) {
                  echo "<li class=\"list-item\">".$note->Source." : ".$note->Value."</li>";
                }
                ?>
              </ul>
            </div>
            ...
            <div class="col-md-5" style="border: 5px solid rgb(111,41,97)">
              <span class="badge badge-default">Acteurs : </span>
              <ul>
                <?php
